 ...
 * @param msg 
 */
void TBot_Walker::publish_velocity(const geometry_msgs::msg::Twist::SharedPtr msg) {
 ...
 * @param msg 
 */
void TBot_Walker::scan_callback(const sensor_msgs::msg::LaserScan::SharedPtr msg) {
    ...
    if (min_distance_to_obstacle <= collision_threshold_) {
        RCLCPP_WARN_STREAM(rclcpp::get_logger("tbot_walker"), "Collision Imminent!");
